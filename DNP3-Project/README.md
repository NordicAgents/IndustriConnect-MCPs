...
Model Context Protocol servers for the DNP3 SCADA protocol. The repository mirrors the MODBUS/S7/EtherCAT stacks with Python and TypeScript runtimes plus a mock outstation so AI agents can poll points, issue controls, and inspect diagnostics safely.
...
├── dnp3-npm/           # TypeScript/Node MCP server
